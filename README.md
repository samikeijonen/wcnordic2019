[![Build Status](https://travis-ci.org/samikeijonen/wcnordic2019.svg?branch=dev)](https://travis-ci.org/samikeijonen/wcnordic2019)
...
- `WcNordic2019\get_svg()` function returns inline SVG icon markup by default.
- For example `WcNordic2019\get_svg( [ 'icon' => 'folder-open' ]`.
