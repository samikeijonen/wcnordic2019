...
add_action(
	...
	function() {
		...
		add_theme_support(
			...
			[
				[
					'name' => esc_html__( 'Small', 'wc-nordic-2019' ),
					'size' => 14,
					'slug' => 'small',
				],
				[
					'name' => esc_html__( 'Medium', 'wc-nordic-2019' ),
					'size' => 20,
					'slug' => 'medium',
				],
				[
					'name' => esc_html__( 'Large', 'wc-nordic-2019' ),
					'size' => 24,
					'slug' => 'large',
				],
				[
					'name' => esc_html__( 'Larger', 'wc-nordic-2019' ),
					'size' => 40,
					'slug' => 'larger',
				],
			]
...
add_action(
	...
	function() {
		...
		register_nav_menus(
			[
				'primary' => esc_html_x( 'Primary', 'nav menu location', 'wc-nordic-2019' ),
				'social'  => esc_html_x( 'Social Links', 'nav menu location', 'wc-nordic-2019' ),
			]
		);
...
add_action(
	...
	function() {
		...
		register_sidebar(
			[
				'id'   => 'primary',
				'name' => esc_html_x( 'Primary', 'sidebar', 'wc-nordic-2019' ),
			] + $args
		);
	},
	5
