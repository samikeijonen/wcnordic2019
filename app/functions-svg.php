...
function get_svg( $args = [] ) {
	...
	if ( empty( $args ) ) {
		return esc_html__( 'Please define default parameters in the form of an array.', 'wc-nordic-2019' );
	}

	// Define an icon.
	if ( false === array_key_exists( 'icon', $args ) ) {
		return esc_html__( 'Please define an SVG icon filename.', 'wc-nordic-2019' );
	}
...
function social_links_icons() {
	 ...
	 */
	return apply_filters( 'wc_nordic_2019_social_links_icons', $social_links_icons ); // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedHooknameFound
}
