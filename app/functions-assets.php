...
add_action(
	...
	function() {
		// Main scripts.
		wp_enqueue_script( 'wc-nordic-2019-app', asset( 'js/app.js' ), null, null, true );

		// Main styles.
		wp_enqueue_style( 'wc-nordic-2019-style', asset( 'css/style.css' ), null, null );
...
add_action(
	...
	function() {
		// Editor styles.
		wp_enqueue_style( 'wc-nordic-2019-editor', asset( 'css/editor.css' ), null, null );

		// Editor scripts.
		wp_enqueue_script(
			'wc-nordic-2019-editor-scripts',
...
function asset( $path ) {
	// Get the manifest.
	$manifest = App::resolve( 'wc_nordic_2019/manifest' );
